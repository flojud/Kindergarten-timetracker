      ...
      <MainContainer>
        <Item>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to KITZE.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to KITZE, accessible from{' '}
                <a href="https://www.kitze.something" rel="external nofollow noopener">
                  https://www.kitze.something
                </a>
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            not effect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver
